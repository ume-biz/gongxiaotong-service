...
import cn.com.gxt.uac.user.UserManager;
...
public class UserManagerImpl extends BaseDBComponent implements UserManager, MessageConst {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.com.gxt.uac.user.UserManager#changePassword(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.com.gxt.uac.user.UserManager#createUser(cn.com.gxt.uac.entity.UmeUserDto)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.com.gxt.uac.user.UserManager#updateUser(cn.com.gxt.uac.entity.UmeUserDto)
	 */
	@Override
