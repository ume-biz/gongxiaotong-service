...
import cn.com.gxt.uac.user.impl.BaseAuthenticator;
...
public class WechatUserCodeAuthenticatorImpl extends BaseAuthenticator<Map<String, Object>> implements MessageConst {
	...
	public Map<String, Object> findBizUser(String accessCode, String optionPasspord, String... options) {
		...
		if (existUmeWechatUser.size() == 0) {
			...
			umeUser = getDao().queryForObject(UmeUserDto.SQLID.FIND, umeWechatUser.getUserId(), UmeUserDto.class);
	...
	public UmeUserDto makeUmeUser(UmeWechatUserDto umeWechatUser) {
		...
		umeUser.setUserId(umeWechatUser.getUserId());
