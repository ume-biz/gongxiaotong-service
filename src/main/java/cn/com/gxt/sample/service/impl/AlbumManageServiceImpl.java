package cn.com.gxt.sample.service.impl;
...
import cn.com.gxt.sample.message.MessageConst;
import cn.com.gxt.sample.service.AlbumManageService;
import cn.com.gxt.sample.service.dto.AlbumDto;
...
public class AlbumManageServiceImpl extends BaseDBComponent implements AlbumManageService, MessageConst {
	...
	public AlbumDto queryAlbumByCode(Long albumCode) {
		...
		List<AlbumContributorDto> contributorList = this.albumContributorService.search(contributorParam);
		...
		List<AlbumTrackDto> trackList = this.albumTrackService.search(trackParam);
	...
	public List<AlbumDto> queryAlbumsByArtist(String artist) {
		...
		List<AlbumBasicDto> albumBasicList = this.albumBasicService.search(queryParam);
	...
	public List<AlbumDto> queryAlbumsByMultiCondition(String artist, AlbumBasicDto album) {
		...
		if (album != null) {
			List<AlbumBasicDto> albumBasicList = this.albumBasicService.search(album);
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cn.com.gxt.sample.service.AlbumAccessService#updateAlbum(cn.com.gxt.sample.service.dto.AlbumDto)
	 */
	@Override
